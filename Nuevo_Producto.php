		...
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="Guardar_Producto.php" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" maxlength="15" class="form-control" id="Nombre" name="Nombre" placeholder="Nombre" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" maxlength="15" class="form-control" id="Marca" name="Marca" placeholder="Marca">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" maxlength="10" class="form-control" id="Lugar_Origen" name="Lugar_Origen" placeholder="Lugar Origen" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="float" maxlength="12"class="form-control" id="Precio" name="Precio" placeholder="Precio" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="int" maxlength="4" class="form-control" id="Cantidad" name="Cantidad" placeholder="Cantidad" required>
					</div>
				</div>

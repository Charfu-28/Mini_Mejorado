...
<html lang="es">
	...
	<body>
		<div class="container">
			...
			<div class="row">
				<a href="Nueva_Factura_U.php" class="btn btn-success">Generar Nueva Factura</a>
				<a href="Menu_Empleado.php" class="btn btn-success">Volver al Menu</a>
				<br>
				<br>
			</div>
					...
					<tbody>
						<?php while ($row = $resultado ->fetch_array(MYSQLI_ASSOC))	{ ?>
							<tr>
								...
								<td><a href="Modificar_Factura_U.php?Codigo_Factura=<?php echo $row["Codigo_Factura"]; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
								<td><a href="#" data-href="Eliminar_Factura_U.php?Codigo_Factura=<?php echo $row["Codigo_Factura"]; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="glyphicon glyphicon-trash"></span></a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>

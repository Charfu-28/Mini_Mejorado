...
<html lang="es">
	...
	<body>
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="Actualizar_Factura_U.php" autocomplete="off">
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<a href="Factura_Venta_Usuario.php" class="btn btn-default">Regresar</a>

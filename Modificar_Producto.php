...
<html lang="es">
	<head>
		...
		<script src="js/ValidarProducto.js" 	type="text/javascript" /> </script>	
		...
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="Actualizar_Producto.php" autocomplete="off">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" maxlength="20" class="form-control" id="Nombre" name="Nombre" placeholder="Nombre" value="<?php echo $row["Nombre"]; ?>" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" maxlength="10" class="form-control" id="Marca" name="Marca" placeholder="Marca" value="<?php echo $row["Marca"]; ?>"  required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" maxlength="10" class="form-control" id="Lugar_Origen" name="Lugar_Origen" placeholder="Lugar Origen" value="<?php echo $row["Lugar_Origen"]; ?>" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="float" maxlength="12" class="form-control" id="Precio" name="Precio" placeholder="Precio" value="<?php echo $row["Precio"]; ?>" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="int" maxlength="4" class="form-control" id="Cantidad" name="Cantidad" placeholder="Cantidad" value="<?php echo $row["Cantidad"]; ?>" required>
					</div>
				</div>
